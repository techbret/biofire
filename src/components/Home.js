                                        ...
                                        <div className="mt-10 sm:mt-12">
                                            <form action="#" className="sm:max-w-xl sm:mx-auto lg:mx-0">
                                                ...
                                                <p className="mt-3 text-sm text-gray-300 sm:mt-4">
                                                    Join the <a href="#" className="font-medium text-white">waitlist</a> for the Biofire Smart Gun. You will also receive relevant updates from Biofire about the program you select.
