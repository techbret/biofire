...
const product = {
  ...
  imageSrc: 'https://www.wideopenspaces.com/wp-content/uploads/2020/09/new-gun-technology2.jpg',
  imageAlt: 'Model wearing light green backpack with black canvas straps and front zipper pouch.',
  breadcrumbs: [
    { id: 1, name: 'Guns', href: '#' },
    { id: 2, name: 'Handguns', href: '#' },
  ],
  sizes: [
    { name: 'Black', description: 'Our proprietary handgun with a case, manual, access to our app and 24/7 customer support in our matte black' },
    { name: 'Cammo', description: 'Our proprietary handgun with a case, manual, access to our app and 24/7 customer support in our camo design'},
  ],
}
          ...
          <section aria-labelledby="options-heading">
            ...
            <form>
              ...
              <div className="mt-10">
                <button
                  type="submit"
                  className="w-full bg-gray-800 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500"
                >
                  Add to bag
                </button>
              </div>
